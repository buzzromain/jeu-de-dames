...
void run_server() {    
    ...
    //Buffer pour l'échange de message.
        ...
        for(int i = 0; i < MAX_CLIENT; i++) 
        {
            ...
            */
            if(FD_ISSET(sockfd, &readfds)) 
            {
                ...
                if((char_read = read(sockfd, buffer, 1024)) == 0)
                {
                ...
                else
                {
                    ...
                    char * response = handle_request(buffer, BUFFER_SIZE);
...
/*
    Initialise tout les cases de client_socket à 0.
*/
